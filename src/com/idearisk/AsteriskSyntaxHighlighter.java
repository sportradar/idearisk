...
public class AsteriskSyntaxHighlighter extends SyntaxHighlighterBase {
  ...
  private static final TextAttributesKey[] EMPTY_KEYS = new TextAttributesKey[0];
	...
	@NotNull @Override public TextAttributesKey[] getTokenHighlights(IElementType tokenType) {
		if (tokenType.equals(AsteriskTypes.SEPARATOR)) {
      return SEPARATOR_KEYS;
    } else if (tokenType.equals(AsteriskTypes.KEY)) {
      return KEY_KEYS;
    } else if (tokenType.equals(AsteriskTypes.VALUE)) {
      return VALUE_KEYS;
    } else if (tokenType.equals(AsteriskTypes.COMMENT)) {
      return COMMENT_KEYS;
